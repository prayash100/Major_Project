...
for i in range(0,86300, 100):
    ...
    best_solution = bee_search_algorithm(renewable_capacity_av, conventional_capacity_av, data, 1000)

    solar_output_bsa, wind_output_bsa, coal_output_bsa, gas_output_bsa = best_solution
...
np.save("new/bsa/freq/BSA_frequency.npy", all_frequencies)    
