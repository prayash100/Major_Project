...
for i in range(0,86300, 100):
    ...
    # Run BSA 
    best_solution_pso = simulated_annealing(renewable_capacity, conventional_capacity, data, 1000)
...
np.save("SA_frequency_data.npy", all_frequencies)    
